...
---------------------------------------------------
-   `2x Analytic cells (2 LED halfcells, 2 photoresistor halfcells, available with 1, 2 and 3 mm inner diameter) <../cad/>`_
-   `base plate bricklet casing <../cad/base_plate.stl>`_
